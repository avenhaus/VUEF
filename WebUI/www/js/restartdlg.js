...
function restart_esp_success(response) {
    ...
    interval = setInterval(function() {
        ...
        var x = document.getElementById("prgrestart");
        x.value = i;
        document.getElementById('restartmsg').innerHTML = "Restarting, please wait...." + (41 - i) + " seconds";
        if (i > 40) {
...
function restart_esp_failed(errorcode, response) {
    ...
    document.getElementById('restartmsg').innerHTML = "Restart failed : " + errorcode + " :" + response;
